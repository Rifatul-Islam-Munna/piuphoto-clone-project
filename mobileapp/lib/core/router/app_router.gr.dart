...
/// generated route for
/// [InvitationsPage]
class InvitationsRoute extends PageRouteInfo<void> {
  const InvitationsRoute({List<PageRouteInfo>? children})
    : super(InvitationsRoute.name, initialChildren: children);
...
class TemplatesRoute extends PageRouteInfo<void> {
  const TemplatesRoute({List<PageRouteInfo>? children})
    : super(TemplatesRoute.name, initialChildren: children);
